...
%DIF DEL ./hw_old.tex                  Sun Nov 12 20:24:33 2023
%DIF ADD ./hw1_andras_schifferer.tex   Sun Nov 12 20:16:44 2023
...
\usepackage{amsthm}
%DIF 18c18-193
%DIF < \bibliography{refs.bib}
%DIF -------
% $ biblatex auxiliary file $ %DIF > 
% $ biblatex bbl format version 3.2 $ %DIF > 
% Do not modify the above lines! %DIF > 
% %DIF > 
% This is an auxiliary file used by the 'biblatex' package. %DIF > 
% This file may safely be deleted. It will be recreated by %DIF > 
% biber as required. %DIF > 
% %DIF > 
\begingroup %DIF > 
\makeatletter %DIF > 
\@ifundefined{ver@biblatex.sty} %DIF > 
  {\@latex@error %DIF > 
     {Missing 'biblatex' package} %DIF > 
     {The bibliography requires the 'biblatex' package.} %DIF > 
      \aftergroup\endinput} %DIF > 
  {} %DIF > 
\endgroup %DIF > 
 %DIF > 
 %DIF > 
\refsection{0} %DIF > 
  \datalist[entry]{anyt/global//global/global} %DIF > 
    \entry{stable_polys_Barth_Martin_Wilkinson_1967}{article}{} %DIF > 
      \name{author}{3}{}{% %DIF > 
        {{hash=01a5af85b9bec8aa8ed3cf2b17d0ae90}{% %DIF > 
           family={Barth}, %DIF > 
           familyi={B\bibinitperiod}, %DIF > 
           given={W.}, %DIF > 
           giveni={W\bibinitperiod}}}% %DIF > 
        {{hash=105dc07e27e9d62cbc52455bbe2e1c72}{% %DIF > 
           family={Martin}, %DIF > 
           familyi={M\bibinitperiod}, %DIF > 
           given={R.\bibnamedelimi S.}, %DIF > 
           giveni={R\bibinitperiod\bibinitdelim S\bibinitperiod}}}% %DIF > 
        {{hash=4796426128f80cbbadb24aa86b432d19}{% %DIF > 
           family={Wilkinson}, %DIF > 
           familyi={W\bibinitperiod}, %DIF > 
           given={J.\bibnamedelimi H.}, %DIF > 
           giveni={J\bibinitperiod\bibinitdelim H\bibinitperiod}}}% %DIF > 
      } %DIF > 
      \strng{namehash}{1819576ac12466b7ff42dcd0e3e61ed6} %DIF > 
      \strng{fullhash}{1819576ac12466b7ff42dcd0e3e61ed6} %DIF > 
      \strng{bibnamehash}{1819576ac12466b7ff42dcd0e3e61ed6} %DIF > 
      \strng{authorbibnamehash}{1819576ac12466b7ff42dcd0e3e61ed6} %DIF > 
      \strng{authornamehash}{1819576ac12466b7ff42dcd0e3e61ed6} %DIF > 
      \strng{authorfullhash}{1819576ac12466b7ff42dcd0e3e61ed6} %DIF > 
      \field{labelalpha}{BMW67} %DIF > 
      \field{sortinit}{B} %DIF > 
      \field{sortinithash}{d7095fff47cda75ca2589920aae98399} %DIF > 
      \field{labelnamesource}{author} %DIF > 
      \field{labeltitlesource}{title} %DIF > 
      \field{journaltitle}{Numerische Mathematik} %DIF > 
      \field{number}{5} %DIF > 
      \field{title}{Calculation of the eigenvalues of a symmetric tridiagonal matrix by the method of bisection} %DIF > 
      \field{volume}{9} %DIF > 
      \field{year}{1967} %DIF > 
      \field{pages}{386\bibrangedash 393} %DIF > 
      \range{pages}{8} %DIF > 
      \verb{doi} %DIF > 
      \verb 10.1007/bf02162154 %DIF > 
      \endverb %DIF > 
    \endentry %DIF > 
    \entry{sturm-ortega1960}{article}{} %DIF > 
      \name{author}{1}{}{% %DIF > 
        {{hash=ccc7f1d94b8d0e1a3e75d9b37bfc14e5}{% %DIF > 
           family={Ortega}, %DIF > 
           familyi={O\bibinitperiod}, %DIF > 
           given={James\bibnamedelima M.}, %DIF > 
           giveni={J\bibinitperiod\bibinitdelim M\bibinitperiod}}}% %DIF > 
      } %DIF > 
      \strng{namehash}{ccc7f1d94b8d0e1a3e75d9b37bfc14e5} %DIF > 
      \strng{fullhash}{ccc7f1d94b8d0e1a3e75d9b37bfc14e5} %DIF > 
      \strng{bibnamehash}{ccc7f1d94b8d0e1a3e75d9b37bfc14e5} %DIF > 
      \strng{authorbibnamehash}{ccc7f1d94b8d0e1a3e75d9b37bfc14e5} %DIF > 
      \strng{authornamehash}{ccc7f1d94b8d0e1a3e75d9b37bfc14e5} %DIF > 
      \strng{authorfullhash}{ccc7f1d94b8d0e1a3e75d9b37bfc14e5} %DIF > 
      \field{labelalpha}{Ort60} %DIF > 
      \field{sortinit}{O} %DIF > 
      \field{sortinithash}{2cd7140a07aea5341f9e2771efe90aae} %DIF > 
      \field{labelnamesource}{author} %DIF > 
      \field{labeltitlesource}{title} %DIF > 
      \field{journaltitle}{J. ACM} %DIF > 
      \field{title}{On Sturm Sequences for Tridiagonal Matrices} %DIF > 
      \field{volume}{7} %DIF > 
      \field{year}{1960} %DIF > 
      \field{pages}{260\bibrangedash 263} %DIF > 
      \range{pages}{4} %DIF > 
      \verb{urlraw} %DIF > 
      \verb https://api.semanticscholar.org/CorpusID:10659536 %DIF > 
      \endverb %DIF > 
      \verb{url} %DIF > 
      \verb https://api.semanticscholar.org/CorpusID:10659536 %DIF > 
      \endverb %DIF > 
    \endentry %DIF > 
    \entry{paige-1980}{article}{} %DIF > 
      \name{author}{1}{}{% %DIF > 
        {{hash=97020fe21f6f188f1039e583eb8e6fba}{% %DIF > 
           family={Paige}, %DIF > 
           familyi={P\bibinitperiod}, %DIF > 
           given={Christopher\bibnamedelima C.}, %DIF > 
           giveni={C\bibinitperiod\bibinitdelim C\bibinitperiod}}}% %DIF > 
      } %DIF > 
      \list{publisher}{1}{% %DIF > 
        {Elsevier BV}% %DIF > 
      } %DIF > 
      \strng{namehash}{97020fe21f6f188f1039e583eb8e6fba} %DIF > 
      \strng{fullhash}{97020fe21f6f188f1039e583eb8e6fba} %DIF > 
      \strng{bibnamehash}{97020fe21f6f188f1039e583eb8e6fba} %DIF > 
      \strng{authorbibnamehash}{97020fe21f6f188f1039e583eb8e6fba} %DIF > 
      \strng{authornamehash}{97020fe21f6f188f1039e583eb8e6fba} %DIF > 
      \strng{authorfullhash}{97020fe21f6f188f1039e583eb8e6fba} %DIF > 
      \field{labelalpha}{Pai80} %DIF > 
      \field{sortinit}{P} %DIF > 
      \field{sortinithash}{ff3bcf24f47321b42cb156c2cc8a8422} %DIF > 
      \field{labelnamesource}{author} %DIF > 
      \field{labeltitlesource}{title} %DIF > 
      \field{journaltitle}{Linear Algebra and its Applications} %DIF > 
      \field{month}{12} %DIF > 
      \field{title}{{Accuracy and effectiveness of the Lanczos algorithm for the symmetric eigenproblem}} %DIF > 
      \field{volume}{34} %DIF > 
      \field{year}{1980} %DIF > 
      \field{pages}{235\bibrangedash 258} %DIF > 
      \range{pages}{24} %DIF > 
      \verb{doi} %DIF > 
      \verb 10.1016/0024-3795(80)90167-6 %DIF > 
      \endverb %DIF > 
      \verb{urlraw} %DIF > 
      \verb https://doi.org/10.1016/0024-3795(80)90167-6 %DIF > 
      \endverb %DIF > 
      \verb{url} %DIF > 
      \verb https://doi.org/10.1016/0024-3795(80)90167-6 %DIF > 
      \endverb %DIF > 
    \endentry %DIF > 
    \entry{givens-eig}{article}{} %DIF > 
      \name{author}{1}{}{% %DIF > 
        {{hash=57aefd49f7b6d7f8e59408d471aa73ee}{% %DIF > 
           family={White}, %DIF > 
           familyi={W\bibinitperiod}, %DIF > 
           given={Paul\bibnamedelima A.}, %DIF > 
           giveni={P\bibinitperiod\bibinitdelim A\bibinitperiod}}}% %DIF > 
      } %DIF > 
      \strng{namehash}{57aefd49f7b6d7f8e59408d471aa73ee} %DIF > 
      \strng{fullhash}{57aefd49f7b6d7f8e59408d471aa73ee} %DIF > 
      \strng{bibnamehash}{57aefd49f7b6d7f8e59408d471aa73ee} %DIF > 
      \strng{authorbibnamehash}{57aefd49f7b6d7f8e59408d471aa73ee} %DIF > 
      \strng{authornamehash}{57aefd49f7b6d7f8e59408d471aa73ee} %DIF > 
      \strng{authorfullhash}{57aefd49f7b6d7f8e59408d471aa73ee} %DIF > 
      \field{labelalpha}{Whi58} %DIF > 
      \field{sortinit}{W} %DIF > 
      \field{sortinithash}{4315d78024d0cea9b57a0c6f0e35ed0d} %DIF > 
      \field{labelnamesource}{author} %DIF > 
      \field{labeltitlesource}{title} %DIF > 
      \field{journaltitle}{Journal of the Society for Industrial and Applied Mathematics} %DIF > 
      \field{number}{4} %DIF > 
      \field{title}{The Computation of Eigenvalues and Eigenvectors of a Matrix} %DIF > 
      \field{volume}{6} %DIF > 
      \field{year}{1958} %DIF > 
      \field{pages}{393\bibrangedash 437} %DIF > 
      \range{pages}{45} %DIF > 
      \verb{doi} %DIF > 
      \verb 10.1137/0106027 %DIF > 
      \endverb %DIF > 
      \verb{eprint} %DIF > 
      \verb https://doi.org/10.1137/0106027 %DIF > 
      \endverb %DIF > 
      \verb{urlraw} %DIF > 
      \verb https://doi.org/10.1137/0106027 %DIF > 
      \endverb %DIF > 
...
\usepackage{xfrac}
%DIF 33c208
%DIF < \usepackage{minted}
%DIF -------
\usepackage[newfloat]{minted} %DIF > 
%DIF -------
...
%DIF 44a219-220
\newenvironment{code}{\captionsetup{type=listing}}{} %DIF > 
\SetupFloatingEnvironment{listing}{name=Source Code} %DIF > 
%DIF -------
\graphicspath{../plots/}
...
at={(1.083in,0.288in)},
scale only axis,
point meta min=-17.7607697441749,
point meta max=-0.252109195551078,
axis on top,
xmin=0.5,
xmax=100.5,
...
xlabel={$i$},
y dir=reverse,
ymin=-0.364298865211019,
ymax=101.364298865211,
ylabel style={font=\color{white!15!black}},
ylabel={number of eigenvalues in interval},
axis background/.style={fill=white},
title style={font=\bfseries},
title={$W_k$ : $\log_{10} {\left| {\left[W_k - I\right]}_{(i,j)}\right|}$},
colormap/jet,
colorbar
]
\addplot [forget plot] graphics [xmin=0.5, xmax=100.5, ymin=0.5, ymax=100.5] {../plots/lanczos0_W-1.png};
\end{axis}
...
\addplot [color=mycolor1, forget plot]
  table[row sep=crcr]{%
1	2.2204460492503e-16\\
2	2.2204460492503e-16\\
3	3.33066907387545e-16\\
6	3.33066907387545e-16\\
7	4.4408920985006e-16\\
8	4.4408920985006e-16\\
9	5.55111512312574e-16\\
10	7.58941520739859e-16\\
11	1.35915584342782e-15\\
12	1.65492619608186e-15\\
13	2.87053367187264e-15\\
14	6.12530859367414e-15\\
15	1.80731081142468e-14\\
16	4.46643590168442e-14\\
17	1.5487611193521e-13\\
18	6.89077267468367e-13\\
19	3.20675430653947e-12\\
20	1.13222157344105e-11\\
21	5.64032241051615e-11\\
22	3.98911848865917e-10\\
23	1.59775190875044e-09\\
24	6.0557082456197e-09\\
25	2.01600605827248e-08\\
28	1.19735233774198e-06\\
29	4.88149434330433e-06\\
30	1.69947739303902e-05\\
31	5.21707646565768e-05\\
32	0.00013965283385525\\
33	0.000487694099291463\\
35	0.0103577990989598\\
36	0.030762073577099\\
37	0.109368990357681\\
38	0.42481705124019\\
39	0.445297640566034\\
44	0.445297640566034\\
45	0.462699700927053\\
65	0.462699700927053\\
66	0.558053758795446\\
100	0.559616878186833\\
};
\end{axis}
\end{tikzpicture}%}
...
at={(1.083in,0.288in)},
scale only axis,
point meta min=-19.2659197224948,
point meta max=-8.86855576143199,
axis on top,
xmin=0.5,
xmax=100.5,
xlabel style={font=\color{white!15!black}},
...
\addplot [forget plot] graphics [xmin=0.5, xmax=100.5, ymin=0.5, ymax=100.5] {../plots/lanczos1_W-1.png};
\end{axis}
...
xlabel={$k$},
ymode=log,
ymin=2.68882138776405e-17,
ymax=6.58920963235096e-09,
yminorticks=true,
ylabel style={font=\color{white!15!black}},
ylabel={$w_{k, \infty}$},
axis background/.style={fill=white},
...
\addplot [color=mycolor1, forget plot]
  table[row sep=crcr]{%
2	2.68882138776406e-17\\
3	2.2204460492503e-16\\
4	4.02889527295619e-16\\
5	4.70543742858704e-16\\
6	4.70543742858704e-16\\
7	5.45678953411959e-16\\
8	6.6613381477509e-16\\
9	1.0395330429791e-15\\
10	1.98595344813244e-15\\
11	4.51960517622308e-15\\
12	1.27432786545254e-14\\
13	2.12539404478847e-14\\
14	3.41703119792476e-14\\
15	4.95823000712376e-14\\
16	1.18727076781065e-13\\
17	2.09579532547965e-13\\
18	7.04030624488857e-13\\
19	2.74736125776415e-12\\
20	8.43076715210944e-12\\
21	1.9980420313051e-11\\
22	8.11048085245732e-11\\
23	3.51104513979283e-10\\
25	5.23941691074605e-09\\
26	1.35345631230298e-09\\
37	1.35345631230298e-09\\
38	2.97980486986537e-09\\
39	1.35345631230298e-09\\
49	1.35345631230298e-09\\
50	6.58920963235101e-09\\
51	1.35345631230298e-09\\
59	1.35345631230298e-09\\
60	2.31699759378758e-09\\
61	1.35345631230298e-09\\
69	1.35345631230298e-09\\
70	6.21466810478428e-09\\
71	1.35345631230298e-09\\
78	1.35345631230298e-09\\
79	5.59819630409349e-09\\
80	1.35345631230298e-09\\
87	1.35345631230298e-09\\
88	5.68194333597218e-09\\
89	1.35345631230298e-09\\
96	1.35345631230298e-09\\
97	3.68448622740244e-09\\
98	1.35345631230298e-09\\
99	1.35345631230298e-09\\
};
\end{axis}
\end{tikzpicture}%}
...
\DIFaddbegin \subsection{\DIFadd{Stability of the eigenvalue algorithm}}

\DIFadd{If we apply the above algorithm for finding eigenvalue we will soon notice a limitation of the algorithm for larger matrices: it simply fails to work for sizes from $\sim 800$ and up. The reason has to do with the evaluation of the sequence of polynomials which results in a faulty $s(x)$. This root cause, as noted by \mbox{%DIFAUXCMD
\textcite{stable_polys_Barth_Martin_Wilkinson_1967} }\hskip0pt%DIFAUXCMD
is that during the evaluation of the polynomial sequence floating point number overflow happens. To prevent this a more stable sequence is suggested by }\autocite{stable_polys_Barth_Martin_Wilkinson_1967}\DIFadd{, namely one that keeps track of the ratio of the polynomials so that 
}\begin{equation}
	\DIFadd{q_{i} = \frac{p_i(x)}{p_{i-1}(x)} \quad \mathrm{for}\, i = 1, 2, \dots n.
}\end{equation}
\DIFadd{Thereby the recursion transforms into 
}\begin{align}
	\DIFadd{q_{0}(x) }&\DIFadd{= \alpha_1 - x,}\\
	\DIFadd{q_{i}(x) }&\DIFadd{= \alpha_i - x - \frac{\beta_{i}^2}{q_{i-1}(x)}.
}\end{align}

\DIFadd{This seems to aleviate the problems one might face in the next section.
}

\DIFadd{Here as a test case two randomly generated tridiagonal symmetric matrices are used to test the algorithm in }\autoref{fig:eig-stability}\DIFadd{, which suggests that the stabilized version works well.
}\begin{figure}[h!]
	\centering
	\begin{subfigure}{0.35\textheight}
		\centering
		\includegraphics[width=\textwidth]{../plots/eig_rand_test_k25_s0.pdf}
		\subcaption{\DIFaddFL{Random tridiagonal matrix with $n=25$, }\textbf{\DIFaddFL{unstable}} \DIFaddFL{eigenvalue algorithm}}
	\end{subfigure}
	\begin{subfigure}{0.35\textheight}
	\centering
	\includegraphics[width=\textwidth]{../plots/eig_rand_test_k800_s0.pdf}
	\subcaption{\DIFaddFL{Random tridiagonal matrix with $n=800$, }\textbf{\DIFaddFL{unstable}} \DIFaddFL{eigenvalue algorithm}}
	\end{subfigure}

	\begin{subfigure}{0.35\textheight}
	\centering
	\includegraphics[width=\textwidth]{../plots/eig_rand_test_k25_s1.pdf}
	\subcaption{\DIFaddFL{Random tridiagonal matrix with $n=25$, }\textbf{\DIFaddFL{stable}} \DIFaddFL{eigenvalue algorithm}}
	\end{subfigure}
	\begin{subfigure}{0.35\textheight}
	\centering
	\includegraphics[width=\textwidth]{../plots/eig_rand_test_k800_s1.pdf}
	\subcaption{\DIFaddFL{Random tridiagonal matrix with $n=800$, }\textbf{\DIFaddFL{stable}} \DIFaddFL{eigenvalue algorithm}}
	\end{subfigure}

	\caption{\DIFaddFL{Testing the }\textbf{\DIFaddFL{stable}} \DIFaddFL{and }\textbf{\DIFaddFL{unstable}} \DIFaddFL{eigenvalue finding algorithms for two random suitable matrices. Apart from the eigenvalues $s(x)$ is also compared to the matlab }\texttt{\DIFaddFL{eig}} \DIFaddFL{function's results.}}\label{fig:eig-stability}
\end{figure}

\DIFaddend \subsubsection*{Finding mutliple eigenvalues at the same time}
...
\begin{algorithm2e}[ht]
	...
	\DIFdelbegin %DIFDELCMD < \Fn{\FMain{$K, a, b, \alpha, \beta$}}{
%DIFDELCMD < 		\uIf{$|K|=0$}{\Return{$[\quad]$\tcp{No eigenvalues in this interval to be found}}}
%DIFDELCMD < 		\uElseIf{$\frac{b-a}{b} < 2\epsilon$}{
%DIFDELCMD < 			\tcp{The eigenvalues could not be resolved any further}
%DIFDELCMD < 			\Return{$\underbrace{\left[\frac{a+b}{2},\,\frac{a+b}{2},\,\dots,\frac{a+b}{2}\right]}_{\left|K\right| \,\mathrm{ elements}}$}
%DIFDELCMD < 		}
%DIFDELCMD < 		\uElseIf{$\frac{b-a}{b} > \kappa$ \textbf{or} $|K| > 1$}{
%DIFDELCMD < 			$c = \frac{a+b}{2}$\\
%DIFDELCMD < 			\tcc{Using \autoref{alg:char-poly-eval} to evaluate $s(c)$ in $\mathcal{O}(j)$. Values are cached in reality}
%DIFDELCMD < 			\Return{\texttt{SetBisect}$\left(K \cap \Upsilon\left(s(a),s(c)\right),a,c, \alpha, \beta\right)\,$ $\cup\footnotemark\,$ \texttt{SetBisect}$\left(K \cap \Upsilon\left(s(c),s(b)\right),c, b, \alpha, \beta\right)$\tcp{Recursion}}
%DIFDELCMD < 		}
%DIFDELCMD < 		\Else{\Return{$\left[\frac{a+b}{2}\right]$}\tcp{Eigenvalue resolved with $\frac{\kappa}{2}$ precision in this interval}}
%DIFDELCMD < 	}
%DIFDELCMD < 	%%%
\DIFdelend \DIFaddbegin \Fn{\FMain{$K, a, b, \alpha, \beta$}}{
...
\FloatBarrier
\section{\DIFadd{Atomic Force Microscopy}}
\begin{code}
...
\end{code}
	\DIFadd{$U S^{\frac{1}{2}} \bigl( \underbrace{S^{-\frac{1}{2}} U^\intercal K V S^{-\frac{1}{2}}}_{A} - \omega^2 I\bigr)S^{\frac{1}{2}} V^\intercal \delta \mathbf{u} = 0 $
}\DIFaddend 
